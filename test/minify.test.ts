...
describe('Minify Tests', () => {
	...
	test('should minify with complex re-exports and barrel files', async () => {
		...
		expect(files).toHaveLength(1)
		expect(files[0].dts).toMatchInlineSnapshot(
			`"declare namespace v{export{m as subtract,d as sqrt,L as power,i as multiply,N as divide,t as add,c as PI,p as E}}declare function t(a:number,b:number): number;declare function m(a:number,b:number): number;declare function i(a:number,b:number): number;declare function N(a:number,b:number): number;declare function L(base:number,exponent:number): number;declare function d(value:number): number;declare const c:number;declare const p:number;declare namespace g{export{B as truncate,x as slugify,f as reverse,n as capitalize}}declare function n(str:string): string;declare function f(str:string): string;declare function B(str:string,length:number): string;declare function x(str:string): string;declare namespace h{export{o as unique,y as shuffle,V as groupBy,u as chunk}}declare function u<T>(array:T[],size:number): T[][];declare function o<T>(array:T[]): T[];declare function y<T>(array:T[]): T[];declare function V<T,K extends string|number>(array:T[],keyFn:(item:T)=>K): Record<K,T[]>;declare namespace l{export{S as StringValidator}}declare class S{static isValidEmail(email:string):boolean;static isValidURL(url:string):boolean;static isNotEmpty(str:string):boolean;static hasLength(str:string,min:number,max?:number):boolean;}declare namespace s{export{M as NumberValidator}}declare class M{static isValidNumber(value:any):value is number;static isInRange(value:number,min:number,max:number):boolean;static isPositive(value:number):boolean;static isNegative(value:number):boolean;}declare function w(email:string): boolean;declare function k(value:any): boolean;declare function q(numbers:number[]): number;declare const z:{};export{k as validateNumber,w as validateEmail,o as unique,B as truncate,n as toTitleCase,t as sum,m as subtract,d as sqrt,u as splitArray,x as slugify,y as shuffle,f as reverse,i as product,L as power,i as multiply,V as groupBy,N as divide,z as default,o as deduplicate,u as chunk,n as capitalize,q as calculateSum,t as add,l as StringValidator,l as StringUtils,g as String,c as PI,s as NumberValidator,s as NumberUtils,v as Math,p as E,h as Array};"`,
		)
	})
